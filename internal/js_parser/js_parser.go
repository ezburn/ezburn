...
import (
	...
	"github.com/ezburn/ezburn/internal/ast"
	"github.com/ezburn/ezburn/internal/compat"
	"github.com/ezburn/ezburn/internal/config"
	"github.com/ezburn/ezburn/internal/helpers"
	"github.com/ezburn/ezburn/internal/js_ast"
	"github.com/ezburn/ezburn/internal/js_lexer"
	"github.com/ezburn/ezburn/internal/logger"
	"github.com/ezburn/ezburn/internal/renamer"
	"github.com/ezburn/ezburn/internal/runtime"
)
...
type parser struct {
	...
	//   })(ns || (ns = {}));
	//
	// Relevant issue: https://github.com/ezburn/ezburn/issues/1158
				...
				case "declare":
					if !p.lexer.HasNewlineBefore && opts.isClass && p.options.ts.Parse && opts.tsDeclareRange.Len == 0 {
						...
						if prop, ok := p.parseProperty(startLoc, kind, opts, nil); ok &&
							...
							// References:
							//
							//   https://github.com/ezburn/ezburn/issues/1675
				...
				case "abstract":
					if !p.lexer.HasNewlineBefore && opts.isClass && p.options.ts.Parse && !opts.isTSAbstract {
						...
						if prop, ok := p.parseProperty(startLoc, kind, opts, nil); ok &&
							...
							// References:
							//
							//   https://github.com/ezburn/ezburn/issues/3684
							//
							prop.Kind = js_ast.PropertyDeclareOrAbstract
							return prop, true
						}
		...
		default:
			...
			case js_ast.UnOpVoid:
				...
				if p.options.minifySyntax {
					...
					//
					// More info: https://github.com/ezburn/ezburn/issues/4041
